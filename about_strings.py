...
def test_string_methods():
    ...
    assert 'Hello' == 'hello'.capitalize() # Переводит первый символ строки в верхний регистр, а все остальные в нижний
    assert 'HELLO' == 'hello'.upper()
    assert 'hello world' == 'Hello World'.lower() 
    assert 'Hello World' == 'hello world'.title() # Первую букву каждого слова переводит в верхний регистр, а все остальные в нижний
    assert 'hElLO WorLD' == 'HeLlo wORld'.swapcase() # Переводит символы нижнего регистра в верхний, а верхнего – в нижний
